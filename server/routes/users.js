...
router.delete('/follow/:id', protect, asyncHandler(async (req, res) => {
  await getSupabase()
    .from('follows')
    .delete()
    .eq('follower_id', req.user.id)
...
router.get('/me/requests', protect, asyncHandler(async (req, res) => {
  const db = getSupabase();
  const { data } = await db
...
router.post('/friend-request/:id', protect, asyncHandler(async (req, res) => {
  const targetId = req.params.id;
  const db = getSupabase();
...
router.post('/accept-friend/:id', protect, asyncHandler(async (req, res) => {
...
router.post('/decline-friend/:id', protect, asyncHandler(async (req, res) => {
  await getSupabase()
    .from('friend_requests')
    .delete()
...
router.delete('/friend/:id', protect, asyncHandler(async (req, res) => {
  const db = getSupabase();
...
router.post('/language', protect, asyncHandler(async (req, res) => {
...
router.post('/verify-language-otp', protect, asyncHandler(async (req, res) => {
  const { otp } = req.body;
  const user = req.userRow;
