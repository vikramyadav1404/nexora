...
export default function Profile() {
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      setEditForm({ name: res.data.user.name, bio: res.data.user.bio || '', phone: res.data.user.phone || '' });
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div className="profile-hero">
          ...
          <div style={{ flex: 1 }}>
            {editing ? (
              <div>
                <input className="form-input" value={editForm.name} onChange={e => setEditForm({ ...editForm, name: e.target.value })} style={{ marginBottom: 8 }} />
